...
| `simulator/battle.py` | Round-loop core (S79): phase-5 order -> per-actor turn gates -> validated damage models -> phase-9 DoT. Components engine-exact; the LOOP GLUE is traced-only, NOT yet differentially validated (S81). |
