...
| `simulator/s85_battle_events.json` | The S85 corpus: 25 battles / ~190 rounds (real-save unforced vs EID 7/1/3 ×1-3, forced Beat/Sleep/Surround/StopSpell/Sacrifice/Kamikaze/PoisonAir/PoisonHit/Paralyze, curse/heavy-DoT/stun status pokes, party KO, heal, MP-veto). Captured on the S85 patched ROM `4c8de38a…` (the S85b Anchor rewrite changes only what an AI-committed $E4 becomes; the corpus's E4 turns are the no-op form). |
