...
ClearTextQueuedFlag:
    ...
    ld a, [$d8da]
    ld h, a                  ; Text ID high → H (also in A)
    jp TextQueueCheck_Ext    ; → extended handler in padding area
    rst $38                  ; padding
...
DispatchBank0F:
    jp DispatchBank0F_Ext    ; → extended handler in padding area
    rst $38                  ; padding (2 bytes to match original 5-byte size)
    rst $38
