...
SkillLearnReqTable:  ; $06:$50E0 — 222 x 18 B, skill-id order (see the annotated
;   copy in disassembly/bank_006.asm for the full field breakdown; label added S51).
...
Jump_006_6b87:
    ...
    call MapIDClampForPalette   ; custom rooms → safe mapID < $50
    cp $50
    jr c, jr_006_6ba7
