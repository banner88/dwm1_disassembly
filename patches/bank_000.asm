...
;   Docs: TEXT_SYSTEM.md, ENCYCLOPEDIA_DETAIL_FREEZE.md.
CallTextEngine:
    push de
...
Data_2A30:
    ...
    ld d, b
    nop
; @BUILD_PROJECT BEGIN rom0_room_records
; $26DD records for mapIDs $6B-$6F ($2A35-$2A5C, 8 B each) — generated by
...
; that filler. Labels inside the window are jr targets and stay put.
    db $0D, $28, $A0  ; $6B gate_island: gfx $28:$0D, 160x256, thr $30
Data_2A38:
    db $00, $00, $01, $30, $00
DataTable_2A3D:
    db $0D, $28, $A0  ; $6C dusk_mirror: gfx $28:$0D, 160x256, thr $30
DataLookup_2A40Alias:
DataLookup_2A40:
    db $00, $00, $01, $30, $00
    db $0D, $28, $A0  ; $6D gate_rotation: gfx $28:$0D, 160x128, thr $30
Data_2A48:
    db $00, $80, $00, $30, $00
    db $12, $24, $A0, $00, $80, $00, $50, $00  ; $6E placeholder (vanilla filler)
    db $12  ; $6F placeholder (vanilla filler)
DataTable_2A56:
    db $24, $A0
Data_2A58:
    db $00
DataLookup_2A59:
    db $80, $00, $50, $00
; @BUILD_PROJECT END rom0_room_records
    nop
    jr z, Data_29E0
