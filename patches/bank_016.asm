...
FamilyRecipeTable:  ; $4974 — 222 entries x 2B (species 0-221); ends at SpecialRecipeTable ($4B30).
    ...
    ; forked via FamilyRecipeResolve to return $FF,$FF ("no recipe"). See BREEDING_SYSTEM.md.
    db $f3, $f1, $f0, $f2, $f0, $f3, $f0, $f4, $f0, $f5, $f0, $f6, $f0, $f7, $f0, $f8
    ...
    db $f1, $b8, $f1, $77, $f1, $5f, $f1, $06, $f1, $7d, $f1, $f1, $f1, $4f, $26, $26
    db $27, $27, $22, $8c, $f1, $8d, $f1, $55, $2b, $29, $f2, $f0, $f0, $f1, $f2, $f3
    db $f2, $f4, $f2, $f5, $ff, $ff, $f2, $f7, $f2, $f8, $ff, $ff, $f2, $a4, $f2, $15
    db $f2, $4a, $f2, $62, $f2, $f6, $f2, $8f, $f2, $bb, $f2, $21, $f2, $0a, $f2, $00
    db $f2, $4b, $40, $40, $41, $41, $f2, $f9, $f2, $1c, $f2, $87, $f3, $f0, $f2, $f1
...
SpecialRecipeTable:  ; $4B30 — 825 entries x 5 bytes, $FF terminated
    ...
    db $89, $f7, $00, $96, $00, $2a, $35, $00, $13, $00, $8c, $f7, $00, $96, $00, $83
    ...
    db $00, $f4, $b5, $00, $69, $00, $f7, $1b, $00, $9c, $00, $35, $2a, $00, $13, $00
...
FamilyRecipeResolve:
    ...
    ld a, l
    cp $bc                        ; h==1: l>=$bc means id*2>=$1bc i.e. id>=222
    jr nc, .none
.normal:
    ld a, l
