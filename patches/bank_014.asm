...
EnemyStats_001:
    ...
    db $E9, $E5, $E4, $09  ; [MOURN S75] Mourn ($E9) slot0 test harness + Tremor ($E5) + Anchor ($E4) + Infernos ($09)
...
; --- Phase N: new-species enemy-stats entries placed in free space ---
; (generated by tools/build_new_species.py; addresses chosen so vanilla
;  LoadEnemyStats addresses them via EID*25+$4C1D with no code fork)
    ds 6, $00
