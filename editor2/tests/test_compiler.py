...
def main():
    ...
    ok("all nine targets produced",
       sorted(out1) == ['patches/bank_000.asm',
                        'patches/bank_014.asm', 'patches/bank_017.asm',
